...
from .lightning_module import STULightningModule
...
class STUEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a STU model https://arxiv.org/abs/2312.06837.

    This class is uses the model defined in ``STUModel``, and wraps it
    into a ``STULightningModule`` for training purposes: training is
    ...
    def _create_instance_splitter(self, module: STULightningModule, mode: str):
    ...
    def create_lightning_module(self) -> STULightningModule:
        return STULightningModule(
            lr=self.lr,
