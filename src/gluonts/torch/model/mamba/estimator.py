...
from .lightning_module import MambaLightningModule
...
class MambaEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a Mamba model, as described in []().

    This class is uses the model defined in ``MambaModel``, and wraps it
    into a ``MambaLightningModule`` for training purposes: training is
    ...
    def _create_instance_splitter(
        self, module: MambaLightningModule, mode: str
    ):
