...
from .lightning_module import MatryoshkaMSLightningModule
...
class MatryoshkaMSEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a MatryoshkaMS model.

    This class is uses the model defined in ``MatryoshkaMSModel``, and wraps it
    into a ``MatryoshkaMSLightningModule`` for training purposes: training is
    ...
    num_prediction_steps:
        Number of prediction steps per time step (default: 8).
    num_layers
    ...
    def _create_instance_splitter(
        self, module: MatryoshkaMSLightningModule, mode: str
    ):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: MatryoshkaMSLightningModule,
    ...
    def create_lightning_module(self) -> MatryoshkaMSLightningModule:
        return MatryoshkaMSLightningModule(
            lr=self.lr,
