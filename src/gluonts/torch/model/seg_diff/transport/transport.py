...
class Transport:
    ...
    def get_drift(self):
        ...
        def score_ode(x, t, model, **model_kwargs):
            ...
            return (
                -drift_mean + drift_var * model_output
    ...
    def get_score(
        ...
        if self.model_type == ModelType.NOISE:
            ...
            score_fn = (
                ...
                t,
                model,
                **kwargs: self.path_sampler.get_score_from_velocity(
        ...
        *,
        ...
        if last_step is None:
            ...
            last_step_fn = lambda x, t, model, **model_kwargs: x / alpha(t)[0][
                0
            ] + (sigma(t)[0][0] ** 2) / alpha(t)[0][0] * self.score(
    ...
    def sample_sde(
        ...
        *,
        ...
        def _sample(init, model, **model_kwargs):
            ...
            assert (
                len(xs) == num_steps
            ), "Samples does not match the number of steps"
    ...
    def sample_ode_likelihood(
        ...
        *,
        ...
        def _likelihood_drift(x, t, model, **model_kwargs):
            x, _ = x
            eps = (
                th.randint(2, x.size(), dtype=th.float, device=x.device) * 2
                - 1
            )
